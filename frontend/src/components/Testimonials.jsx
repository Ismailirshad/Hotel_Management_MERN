...
const Testimonials = () => {
    return (
        <div id="offers" className='min-h-screen bg-slate-50 w-full '>
            <div className="max-w-7xl pt-52 pb-16 space-y-10 justify-center items-center flex flex-col mx-auto ">

                <div className="flex flex-col items-center">
                    <div className="max-w-3xl text-center space-y-5">
                        <h1 className="text-4xl">What Our Guest Say</h1>
                ...
                <div class="grid grid-cols-1 space-x-5 md:grid-cols-2 lg:grid-cols-3 ">
                    {/* <!-- Testimonial 1 --> */}
                    <div class="w-full max-w-88 space-y-4 rounded-md border border-gray-200 bg-white p-3 text-gray-500 transition-all duration-300 hover:-translate-y-1">
                        <div class="flex items-center justify-between">
                            <div class="flex gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-star size-4 fill-gray-800 text-gray-800" aria-hidden="true">
                                    <path
