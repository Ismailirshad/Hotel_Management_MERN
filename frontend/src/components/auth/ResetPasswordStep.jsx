...
const ResetPasswordStep = ({loading, setLoading, confirmPassword, setConfirmPassword, password, setPassword , onClose, openLogin, email}) => {
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-900/50 border border-emerald-900/50 text-emerald-50 rounded-xl outline-none transition-all duration-300 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 placeholder-gray-600"
                  value={password}
