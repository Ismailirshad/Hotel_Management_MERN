  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-0 -inset-full h-full w-1/2 z-5 block transform -skew-x-12 bg-linear-to-r from-transparent to-white/10 opacity-30 group-hover:animate-shine" />
      </button>
    </>
  )
}
